...
What's New:
- /monitor brain added (post-launch monitoring)
...
If you've edited any brain files locally, /upgrade will warn you before overwriting:

```
You've modified these brain files locally:
- brains/build/CLAUDE.md
...
/upgrade doesn't affect your project at all. It updates the brain files themselves — the instructions that each brain follows. Your SESH.md, STATUS.md, and all project files stay untouched.
