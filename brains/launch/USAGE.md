...
```
~/.claude/skills/apb/brains/launch/
```
...
The brain runs preflight automatically, then walks you through deployment. You'll be asked to confirm before anything goes live.
...
/launch is the final brain. After it runs, your app is live. To make changes later, start a new cycle through the pipeline with /aplayerbrains.
