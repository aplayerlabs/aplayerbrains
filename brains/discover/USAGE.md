...
```
~/.claude/skills/apb/brains/discover/
```
...
The brain will ask you structured questions about the problem: who has it, what they do today, why it hurts, how often.
...
The brain will work backward from your idea to find the problem underneath. "Who would use this, and what problem does it solve for them?"
...
The brain reads these directly — you don't need to explain what's in them.
...
```
/aplayerbrains → [ /discover ] → /plan → ...
```

/discover is the first brain. It creates the project state files (SESH.md, STATUS.md) that every other brain reads and builds on.
