...
## TT-006: Playbooks live in the brain, not in projects

**Date:** 2026-04-06
**Decision:** Testing playbooks (edge cases, security, performance, accessibility) ship with the brain, not in individual project folders.
**Why:** Testing knowledge accumulates across projects. The edge cases that matter for one client's login form matter for every login form. Playbooks are IP that travels with the brain — reusable patterns that make every test session more thorough than the last. If they lived in projects, they'd fragment and diverge.
