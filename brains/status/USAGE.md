...
The brain reads your project's SESH.md and STATUS.md and gives you a plain English report.

**No project found:**
```
No project state found here. Type /aplayerbrains or /discover to start a new project.
```
...
Works well paired with /aplayerbrains — /status tells you where you are, /aplayerbrains tells you where to go.
