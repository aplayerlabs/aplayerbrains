...
**Why:** If /status could "fix" SESH.md, it becomes a maintenance tool that might mask problems. A corrupt or stale SESH.md should be visible to the user, not silently patched by a reporting brain. The brain that owns the section should be the one to fix it.
...
**Date:** 2026-04-06
**Decision:** Every status report ends with "Type /[brain] to continue" or equivalent.
