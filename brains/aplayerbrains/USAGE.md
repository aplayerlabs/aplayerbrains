...
Or say: "start", "what should I do", "a player brains"

## What happens

The brain reads your project directory and tells you where you are:
...
This brain sits outside the pipeline. It reads the project state and points you to the right brain. It never modifies anything.
