...
Token and Scripter patterns follow the same principles as the standalone designer playbook (`~/cc/apb/designer/`), but scoped to the screens identified from the PRD.
