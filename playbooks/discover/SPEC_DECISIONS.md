...
**Why:** Business owners arrive in two very different mental states. Someone with a pain point needs validation — "yes, this is real." Someone with an idea needs redirection — "what problem does this solve?" The questioning strategy differs. PROBLEM mode validates forward; IDEA mode works backward. Merging them creates a muddled experience where the playbook doesn't know which direction to push.
